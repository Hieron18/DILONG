...
if (iconMenu != null) {
	...
	let menulogo = document.querySelector(".header__adatptiv-two");
...
let sliderSlider2 = new Swiper('.product__slider', {
	autoplay: {
		delay: 3000,
		disableOnInteraction: true,
	},
...
let sliderSlider3 = new Swiper('.product__slider2', {
	autoplay: {
		delay: 3000,
		disableOnInteraction: true,
	},
...
let sliderSlider4 = new Swiper('.product__slider3', {
	autoplay: {
		delay: 3000,
		disableOnInteraction: true,
	},
	...
	// Arrows
	navigation: {
		nextEl: '.product-button-next3',
		prevEl: '.product-button-prev3',
	},
	breakpoints: {
		320: {
			slidesPerView: 2,
...
//  });
 ...
 var merchandiseSliderOne = new Swiper('.merchandise__slider-one', {
	spaceBetween: 10,
	thumbs: {
	  swiper: merchandiseSliderOne,
	},
	//preloadImages: false,
	//lazy: true,
	// Dotts
	...
	// Arrows
	navigation: {
		nextEl: '.merchandise-button-next',
		prevEl: '.merchandise-button-prev',
	},
	// pagination: {
	// 	el: ".swiper-pagination",
	//  },
...
var merchandiseSliderTwo = new Swiper('.merchandise__slider-two', {
	spaceBetween: 16,
	slidesPerView: 4,
	freeMode: true,
	watchSlidesProgress: true,
...
var merchandiseSliderTwo = new Swiper('.comparison__sliders', {
	// autoplay: {
	// 	delay: 3000,
	// 	disableOnInteraction: true,
	// },
...
let acitveTop = document.querySelector('.menu__item_active');
let acitveBottom = document.querySelector('.menu__item_active2');
let priceAcitve = document.querySelector('.price__kp');
let directory = document.querySelector('.header__directory');

if(priceAcitve){
   priceAcitve.addEventListener('click', function (e) {
      e.preventDefault();
      priceAcitve.classList.toggle('_open');
   })
}

if(acitveTop && acitveBottom && directory){
   acitveTop.addEventListener('click', function (e) {
      acitveTop.classList.toggle('_open');
   })

   acitveBottom.addEventListener('click', function (e) {
      acitveBottom.classList.toggle('_open');
   })

   directory.addEventListener('click', function (e) {
      directory.classList.toggle('_open');
   })
}

let cross = document.querySelector(".control__cross");
let notification = document.querySelector(".control__notification");
if(cross){
   cross.addEventListener('click', function () {
      notification.classList.add('_crossRemove')
   })
}

let showUser = document.querySelectorAll(".user__show");
let roster;
if(showUser){
   showUser.forEach(user => {
      user.addEventListener('click', function(e) {
         e.preventDefault();
         roster = user.querySelector(".control__roster");
         roster.classList.add('_control-roster');
         user.classList.add('_control-roster');
      })
   });
}

let showUser2 = document.querySelector(".user__show2");
let scrollUser = document.querySelector(".user__scroll");
if(showUser2){
   showUser2.addEventListener('click', function (e) {
      e.preventDefault();
      scrollUser.classList.remove('_user-height');
      showUser2.classList.add('_control-roster');
   })
}
...
//RANGE
const priceSlider = document.querySelector('.spollers-block__range');
if (priceSlider) {
